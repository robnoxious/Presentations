...
import SpFxTeamsTogether from './components/SpFxTeamsTogether';
import { ISpFxTeamsTogetherProps } from './components/ISpFxTeamsTogetherProps';
...
export default class SpFxTeamsTogetherWebPart extends BaseClientSideWebPart<ISpFxTeamsTogetherWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISpFxTeamsTogetherProps> = React.createElement(
      SpFxTeamsTogether,
      {
